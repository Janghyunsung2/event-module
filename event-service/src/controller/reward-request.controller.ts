...
export class RewardRequestController {
  ...
  create(
    ...
    return this.rewardRequestService.create(createDto);
  }
  ...
  findAll(
    ...
    return this.rewardRequestService.findAll({ page: Number(page), limit: Number(limit), search, status });
  }
  ...
  @ApiResponse({ status: 200, type: RewardResponseDto })
  update(@Param('id') id: string, @Body() updateDto: UpdateRewardRequestDto) {
    return this.rewardRequestService.update(id, updateDto);
  }
  ...
  pending(@Param('id') id: string) {
    return this.rewardRequestService.pending(id);
  }
  ...
  approve(
    ...
    return this.rewardRequestService.approve(id, adminId);
  }
  ...
  reject(
    ...
    return this.rewardRequestService.reject(id, adminId, reason);
  }
}